...
RUN ln -snf /usr/share/zoneinfo/$TZ /etc/localtime && echo $TZ > /etc/timezone \
	...
	&& rm -fr /etc/apt/sources.list.d/trixie.list \
	&& apt-get update
...
ADD --chown=$USER:$GROUPNAME --chmod=755 https://raw.githubusercontent.com/hallowelt/docker-bluespice-formula/4.5.x/_client/mathoid-remote /app/bin
